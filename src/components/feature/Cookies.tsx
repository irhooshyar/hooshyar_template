  ...
  return (
    <>
      <div id="cookieNotice" className="card shadow text-center"
           style={{height: 'auto', position: 'fixed', bottom: '0'}}>
        ...
        <div className="content-wrap">
          <div className="msg-wrap">
            <p>این وب‌سایت از کوکی‌ها یا فناوری‌های مشابه برای بهبود تجربه مرور شما و ارائه توصیه‌های شخصی استفاده
              می‌کند. با ادامه استفاده از وب سایت ما، با سیاست حفظ <a style={{color: "#115cfa"}} href=""> حریم
                شخصی</a> ما موافقت میکنید. </p>
          </div>
          <div>
            <br/>
